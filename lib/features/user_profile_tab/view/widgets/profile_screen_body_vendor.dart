...
import 'package:marakiib_app/features/wallet_screen/view/screens/wallet_screen.dart';

import '../../../../core/widgets/custom_button.dart';
import 'info_user.dart';
import 'package:marakiib_app/generated/app_localizations.dart';

class ProfileScreenBodyVendor extends StatelessWidget {
  const ProfileScreenBodyVendor({super.key});
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            SectionItem(
              text: translate.myFinancings,
              icon: Icons.monetization_on_outlined,
              onTap: () {
                context.push('/MyFinancingsScreen');
              },
            ),

            SectionItem(
              text: translate.mySubscription,
              icon: Icons.card_membership_outlined,
              onTap: () {
                context.push('/MySubscriptionScreen');
              },
            ),
